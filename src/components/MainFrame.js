      ...
      <div className={styles.info}>
        <div className={styles.title}>
          ...
          <p>
            ...
            fringilla vulputate auctor ac, scelerisque eget quam. Nulla sed urna
            nec massa vehicula ullamcorper. Aenean id massa ac mi vehicula
            consectetur sit amet id eros. Nam iaculis at libero id congue. Fusce
            vehicula lacus vel tortor malesuada commodo. Maecenas erat nibh,
            commodo a gravida quis, tempus nec nibh.
          </p>
